# This file was originally part of Cosmos Tokenizer by NVIDIA
# from https://github.com/NVIDIA/Cosmos-Tokenizer/blob/main/cosmos_tokenizer/modules/patching.py
...
class UnPatcher(torch.nn.Module):
    ...
    def _ihaar(self, x):
        for _ in self.range:
            x = self._idwt(x, "haar", rescale=False)
        return x
